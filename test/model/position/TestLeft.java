...
public class TestLeft extends TestCase {
	...
	@Test
	public void testLeft_Success() {
		String file = "resources\\test\\positionMaps\\test_left_success.map";
	...
	@Test
	public void testLeft_Fail_OutOfBounds() {
		String file = "resources\\test\\positionMaps\\test_left_fail_outOfBounds.map";
		Game game = gameReader.readGame(file);
		Map map = game.getMap();
		Agent agent = map.getAllAgents().get(0);
