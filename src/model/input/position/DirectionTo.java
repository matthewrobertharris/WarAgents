...
public class DirectionTo extends DecisionPosition {

	private GetPosition position;

	public DirectionTo(GetPosition position) {
	...
	public String toString() {
		String output = Option.DIRECTION_TO.toString() + " " + getPosition().toString();
		return output;
	}
